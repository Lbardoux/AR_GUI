...
void Clothe::Affiche()
{
	...
	//Vecteur v_translate = (position1 + position2) /2;
	//Vecteur p1_p2 = Vecteur(position2 - position1);

	//Matrice model = Scale(length(p1_P2)) * Rotate(angle(p1_P2)) * Translate(v_translate);
	//m_mesh.affiche(model);
}*/